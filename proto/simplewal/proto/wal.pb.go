...
type WAL_Entry struct {
	...
	LogSeqNumber uint64                 `protobuf:"varint,1,opt,name=logSeqNumber,proto3" json:"logSeqNumber,omitempty"`
...
func (x *WAL_Entry) GetLogSeqNumber() uint64 {
	if x != nil {
		return x.LogSeqNumber
	}
	return 0
}
...
const file_proto_wal_proto_rawDesc = "" +
	"\n" +
	"\x0fproto/wal.proto\"\x8f\x01\n" +
	"\tWAL_Entry\x12\"\n" +
	"\flogSeqNumber\x18\x01 \x01(\x04R\flogSeqNumber\x12\x12\n" +
	...
	"\r_isCheckpointB\x11Z\x0fsimplewal/protob\x06proto3"
